...
class RulesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Rule::create(['id' => 2, 'rule_type_id' => 2, 'rule_owner_id' => 1, 'active' => true,
            'rule' => "{ \"condition\": \"AND\", \"rules\": [ { \"id\": \"dollar_amount\", \"field\": \"dollar_amount\", \"type\": \"double\", \"input\": \"number\", \"operator\": \"less\", \"value\": \"300\" }, { \"id\": \"requester_type\", \"field\": \"requester_type\", \"type\": \"integer\", \"input\": \"select\", \"operator\": \"equal\", \"value\": \"1\" } ], \"not\": false, \"valid\": true }"
        ]);
    }
}
