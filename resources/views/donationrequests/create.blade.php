    ...
    <div class="container">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <input type="text" name="organization" class="form-control" id="inputorganization"
                           placeholder="Name of Organization">
                </div>


                <div class="form-group">
                    <label for="formOrganization" class="col-lg-2 control-label">Which of the following best describes
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="address1" class="form-control" id="inputAddress1"
                                       placeholder="Example: Street Name,Company Name,P.O. Box Number">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="address2" class="form-control" id="inputAddress2"
                                       placeholder="Example: Apartment,Suite,Unit Number,Building,Floor">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-1">
                                <input type="text" name="eventdate" class="form-control" id="inputeventdate"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-1">
                                <input type="text" name="enddate" class="form-control" id="inputenddate"
                                       placeholder="Date Donation will be picked up (if approved)">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputeventpurpose" class="col-lg-2 control-label">Event Purpose:*</label>
                            <div class="col-lg-1">
                                <input type="text" name="eventpurpose" class="form-control" id="inputeventpurpose"
                                       placeholder="Purpose of event..example: raise awareness, generate funds for research, ect.">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="FormAttendees" class="col-lg-2 control-label">Estimated Number of
                                Attendees:*</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-1">
                                <input type="text" name="venue" class="form-control" id="inputvenue"
                                       placeholder="Place event will be held">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputmarketingopportunities" class="col-lg-2 control-label">What are the
                                marketing opportunities to our business if approved?*</label>
                            <div class="col-lg-1">
                                <input type="text" name="marketingopportunities" class="form-control"
                                       id="inputmarketingopportunities"
                                       placeholder="Please provide a brief description of the business value this event creates for the company.">
                            </div>
                        </div>
